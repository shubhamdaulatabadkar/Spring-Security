...
public class AppSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * user.add(User.withDefaultPasswordEncoder().username("shubham").password(
	 * "shubham").roles("USERS").build());
	 * 
	 ...
	 * 
	 * //https://www.youtube.com/watch?v=fjkelzWNSuA&ab_channel=Telusko }
	 */
